    ...
    return Container(
        ...
        child: Align(
          ...
          child: Column(children: const <Widget>[
            SizedBox(height: 20),
            Text(
                'Chức năng của Nhân viên hỗ trợ:\nLưu lại thông tin về cuộc gọi đã hỗ trợ khách hàng gồm: Họ và tên, số điện thoại, dịch vụ hỗ trợ, tên đơn vị của khách hàng.', textAlign: TextAlign.justify),
            SizedBox(height: 20),
            Text(
                'Chức năng của Nhân viên chăm sóc khách hàng: \nGọi kiểm độ hài lòng của khách hàng dựa trên các cuộc gọi của nhân viên hỗ trợ.', textAlign: TextAlign.justify),
            SizedBox(height: 20),
